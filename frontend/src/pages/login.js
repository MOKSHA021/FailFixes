...
const Login = () => {
  ...
  const EnhancedGlassCard = styled(Paper)(() => ({
    background: theme.palette.mode === 'light'
      ? `
    ...
    <Chip
      ...
      sx={{
        ...
        '&:hover': {
          ...
          background: theme.palette.mode === 'light'
            ? `linear-gradient(135deg, ${color}40 0%, ${color}30 100%)`
            : `linear-gradient(135deg, ${color}50 0%, ${color}40 100%)`
        }
      }}
      {...props}
    />
  ...
  const EnhancedTextField = styled(TextField)(() => ({
    ...
    '& .MuiOutlinedInput-root': {
      ...
      '& input:-webkit-autofill': {
        WebkitBoxShadow: `0 0 0 1000px ${theme.palette.mode === 'light' ? 'rgba(255, 255, 255, 0.9)' : 'rgba(30, 41, 59, 0.9)'} inset !important`,
